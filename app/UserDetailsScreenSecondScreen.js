...
const UserDetailsScreenSecondScreen = ({navigation}) => {
  ...
  const handleSubmit = () => {
    ...
    dispatch(createProfileAction({ profileData })).then(()=>{
      console.log('Then сработал 1234')
...
export default UserDetailsScreenSecondScreen;
